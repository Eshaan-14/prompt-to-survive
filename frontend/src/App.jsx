    ...
    <div className="flex flex-col min-h-screen bg-gray-900 text-gray-200">
      ...
      <main className="flex-grow p-6 max-w-4xl mx-auto space-y-6">
        ...
        <p className="text-sm text-gray-300">
          Enter a scenario and add players with their strategies. Then hit "Play Round" to see how your players survive the scenario, narrated by EshaanGPT. Have fun!
        </p>
      </section>
        <GameRound />
      </main>
